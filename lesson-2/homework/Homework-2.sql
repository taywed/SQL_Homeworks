...
select employee_id, first_name, last_name, email, phone_number, hire_date, job_id, salary,commission_pct, manager_id, department_id from employees where department_id = 0
...
select DEPARTMENT_NAME, MANAGER_ID, LOCATION_ID from departments where DEPARTMENT_NAME = 'Marketing'
...
select first_name, last_name, email, phone_number, salary from employees where salary >= 9000 and salary <= 17000
