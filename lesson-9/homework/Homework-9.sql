...
--10
SELECT Employees.EmployeeName, Departments.DepartmentName, COUNT(Employees.EmployeeID) AS EmployeeCount
FROM Employees
INNER JOIN Departments ON Employees.DepartmentID = Departments.DepartmentID
...
--14
SELECT E1.EmployeeName AS Employee, E2.EmployeeName AS Colleague, E1.ManagerID
FROM Employees E1
